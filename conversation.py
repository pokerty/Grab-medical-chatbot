...
def read_age_sex(answer):
    ...
    try:
        ...
        if age < constants.MIN_AGE:
            return ValueError("Ages below 12 are not yet supported.")
        if age > constants.MAX_AGE:
            return ValueError("Maximum possible age is 130.")
    except (AmbiguousAnswerException, ValueError) as e:
        print("{} Please repeat.".format(e))
        return ("Please enter your age AND gender :)")
    return age, sex
